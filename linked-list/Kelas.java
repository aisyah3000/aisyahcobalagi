public class Kelas {
    ...
    public void tambahSetelah(String nama,Siswa s){
        ...
        // TODO: bahas di sesi tentang notasi 0
    ...
    public void hapus(String nama){
        ...
        // nanti test :
        // - hapus element pertama dari list berisi banyak
        // - hapus element pertama dari list berisi satu
        // - hapus element pertama dari list kosong
        if(nama.equals(sekarang.nama)) {
            if(sekarang.berikutnya != null) {
